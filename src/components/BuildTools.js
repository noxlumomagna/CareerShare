    ...
    return (
        <div className="contact common-input-style animation">
            ...
            <div className="input-group file-input">
                ...
                <span><i className='bi bi-image'></i> <p>Upload Photo</p></span>
            </div>
            ...
            <div className="input-row">
                <div className="input-group ">
                    <label >Github</label>
                    <input type="text" placeholder='' value={state.contactInformation?.github} onChange={(e) => githubChangeHandler(e)} />
                </div>
                <div className="input-group multi-input">
                    <label >Linkedin</label>
                    <input type="text" placeholder='' value={state.contactInformation?.linkedin} onChange={(e) => linkedinChangeHandler(e)} />
                </div>
                <div className="input-group multi-input">
                    <label >Twitter</label>
                    <input type="text" placeholder='' value={state.contactInformation?.twitter} onChange={(e) => twitterChangeHandler(e)} />
                </div>
            </div>
        </div>
    )
    ...
    return (
        <div className="info">
            ...
            <ul className="tips-list">
                <li className="tips-item"><span>Share your relevant work history.</span></li>
                <li className="tips-item"><span>Sum up the value of your learnings and background that you will bring.</span></li>
                <li className="tips-item"><span>Be sure to note your highlights and accomplishments.</span></li>
            </ul>
        </div>
    )
}
export function Experience() {
    ...
    return (
        <div className="experience  common-input-style animation">
            <h1>Work Experience</h1>
            <p>Begin with your most recent work experience.</p>
            <div className="input-group">
...
export function EducationInfo() {
    return (
        <div className="info">
            ...
            <h1>Education</h1>
            <ul className="tips-list">
                <li className="tips-item"><span>List your degrees in order of the most recently accomplished.</span></li>
                <li className="tips-item"><span>If currently enrolled, mention your expected graduatation date.</span></li>
                <li className="tips-item"><span>Honors, awards, scholarships or professional certifications are optional.</span></li>
            </ul>
        </div>
    )
}
...
export function ReviewEducation({ addNewEducation, pathLinkHandler }) {
    ...
    return (
        <div className="build-tool-review common-input-style">
            ...
            <button className="build-tool-review-button" onClick={addNewEducation}>Add Additional Degree</button>
        </div>
    )
}
...
export function Skills() {
    ...
    return (
        <div className="skills common-input-style animation">
            <h1>Skills</h1>
            <p>Highlight your relevant skills.</p>
            <div className="input-group">
                <label >Skills:</label>
                <textarea
...
export function Summary() {
    ...
    useEffect(() => {
        let s = state.summary.toString().replaceAll(',', '\n')
        setsummary(s)
    }, [])
    const textAreaHandler = e => {
        setsummary(e.target.value)
        dispatch({
            type: actions.ADD_summary,
            item: e.target.value.split('\n')
        })
    }
    return (
        <div className="summary common-input-style animation">
            <h1>Professional Summary</h1>
...
const buildTools = [GetStarted, Contact, ExperienceInfo, Experience, ReviewExperience, EducationInfo, Education, ReviewEducation, SkillsInfo, Skills]
