        ...
        <div className="build">
            <div className="build-path">
                <div className='path-name-medium'>
                    <span className={counter == 0 ? "active" : ""}>Let's Get Started</span>
                    <span className={(counter == 1 ) ? "active" : ""}>Contact Information</span>
                ...
                <ul className="links">
                    <li className={counter >= 0 ? "active" : ""} onClick={() => (pathLinkHandler(0))}><span>Let's Get Started</span></li>
                    <li className={counter >= 1 ? "active" : ""} onClick={() => (pathLinkHandler(1))}><span>Contact Information</span></li>
            ...
            <div className="build-container">
                <div className="build-tools">
                    ...
                    <div className="control-buttons">
                        ...
                        <button className="save-next" onClick={handleNextButton}>Save &amp; Continue</button>
                    </div>
                </div>
