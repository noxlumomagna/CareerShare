...
function Template3({ contactInformation, experiences, experience, educations, education, skills, summary, color, font }) {
        ...
        <div className='template template3 a4' >
            <div className='main-container' style={backgroundColor}>
                <div className='contact info-container' >
                    ...
                    <div className='profesion-summary'>
                        <h2 style={styles}>Summary</h2>
                        <div >
                            {summary?.map((item) => {
                                return item != "" ? <p className="summary normal-paragraph" key={item}>{item}</p> : null
                            })}
                        </div>
                    </div>
                </div>
