...
function Template2({ contactInformation, experiences, experience, educations, education, skills, summary, color, font }) {
            ...
            <div className="container-bg1" style={backgroundColor}>
                <div className="container-bg2">
                    ...
                    <div className='profile-picture' >
                        <img src={contactInformation.image ? URL.createObjectURL(contactInformation.image) : "/image/profile.png"} />
                    </div>
                    ...
                    <div className='information-container' >
                        <div className='part-a'>
                            <div className="professional-summary subtitle section" style={styles}>
                                <h2 style={styles}>Summary</h2>
                                <div >
                                    {summary?.map((item) => {
                                        return item != "" ? <p style={fontStyles} className="summary normal-paragraph" key={item}>{item}</p> : null

                                    })}
                                </div>
                            </div>
                            <div className="experience subtitle section">
                                <h2 style={styles}>Information</h2>
