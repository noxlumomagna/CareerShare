...
function Template1({ contactInformation, experiences, experience, educations, education, skills, summary, color, font }) {
        ...
        <div className="a4 template template1 " style={fontStyles}>
            ...
            <div className="container-B">
                <div className="professional-summary subtitle section">
                    ...
                    <div >
                        {summary?.map((item) => {
                            return item != "" ? <p className="summary normal-paragraph" key={Math.random()}>{item}</p> : null
