...
function ColorBox({spanColor}) {
    return (
        <div className='color-box'>
                        <label>Choose Template Color Scheme:</label>
                        <div className='colors'>
                            ...
                            <span style={{ "--color": "#dfc412" }} onClick={(e) => spanColor(e)}></span>
                            <span style={{ "--color": "#E5B694" }} onClick={(e) => spanColor(e)}></span>
                            <span style={{ "--color": "#82D3C9" }} onClick={(e) => spanColor(e)}></span>
                            <span style={{ "--color": '#16468E' }} onClick={(e) => spanColor(e)}></span>
